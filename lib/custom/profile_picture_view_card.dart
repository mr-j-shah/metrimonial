...
import 'package:active_matrimonial_flutter_app/redux/libs/profile_picture_view_request/profile_picture_view_request_reject.dart';
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(4),
                    color: Color.fromRGBO(255, 221, 218, 1),
                  ),
                  child: Text('Disable')),
              onPressed: () {
                store.dispatch(profilePictureViewRequestRejectMiddleware(
                    ctx: mainContext, id: request_id));
            ...
            TextButton(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(4),
                    color: Color.fromRGBO(201, 227, 202, 1),
                  ),
                  child: Text('Enable')),
              onPressed: () {
