    ...
    return OneContext().showDialog(
      builder: (context) => AlertDialog(
        ...
        content: StoreConnector<AppState, CustomPopUpViewModel>(
          converter: (store) => CustomPopUpViewModel.fromStore(store),
...
class CustomPopUpViewModel {
  ...
  static fromStore(Store<AppState> store) {
    return CustomPopUpViewModel(
        isGoogle: store.state.featureState.feature?.googleLogin == null
            ? false
            : store.state.featureState.feature?.googleLogin,
        isFacebook: store.state.featureState.feature?.facebookLogin == null
            ? false
            : store.state.featureState.feature?.facebookLogin,
        isTwitter: store.state.featureState.feature?.twitterLogin == null
            ? false
            : store.state.featureState.feature?.twitterLogin,
        valueChanger: store.state.signInState.isPhoneOrEmail,
        ...
        login: ({dynamic context, dynamic email, dynamic password}) =>
            store.dispatch(signInMiddleware(
                email: email, password: password, from: "custom")));
  }
}
