...
class PercentageCalculator {
  ...
  getEducationPercentage() {
    ...
    if(store.state.manageProfileCombineState.educationState
        .educationGetResponse.data.isEmpty || store.state.manageProfileCombineState.educationState
        .educationGetResponse.data == null){
      percentage = 0.0;
    }else{
    ...
    percentage = (store.state.manageProfileCombineState.educationState
        ...
        store.state.manageProfileCombineState.educationState
            .educationGetResponse.data.length)*100/100;
  ...
  getCareerPercentage() {
    ...
    if(store.state.manageProfileCombineState.careerState
        .careerGetResponse.data.isEmpty || store.state.manageProfileCombineState.careerState
        .careerGetResponse.data == null){
      percentage = 0.0;
    }else{
    ...
    percentage = (store.state.manageProfileCombineState.careerState
        ...
        store.state.manageProfileCombineState.careerState
            .careerGetResponse.data.length)*100/100;
    var twodec = percentage.toStringAsFixed(2);
    percentage = double.parse(twodec);
    }
    return percentage;
