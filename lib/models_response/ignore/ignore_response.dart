...
IgnoreResponse ignoreResponseFromJson(String str) => IgnoreResponse.fromJson(json.decode(str));
...
class IgnoreResponse {
  ...
  factory IgnoreResponse.fromJson(Map<String, dynamic> json) => IgnoreResponse(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    mothereTongue: json["mothere_tongue"] == null ? null : json["mothere_tongue"],
  );
