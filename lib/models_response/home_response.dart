...
class HomeResponse {
  ...
  List<ActiveMemberData> data;
  bool result;

  factory HomeResponse.fromJson(Map<String, dynamic> json) => HomeResponse(
        data: json["data"] == null
            ? null
            : List<ActiveMemberData>.from(json["data"].map((x) => ActiveMemberData.fromJson(x))),
...
class ActiveMemberData {
  ...
  factory ActiveMemberData.fromJson(Map<String, dynamic> json) => ActiveMemberData(
