...
DeactivateResponse deactivateResponseFromJson(String str) =>
    DeactivateResponse.fromJson(json.decode(str));

String deactivateResponseToJson(DeactivateResponse data) =>
