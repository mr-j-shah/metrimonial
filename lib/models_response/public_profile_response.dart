...
PublicProfileResponse publicProfileResponseFromJson(String str) => PublicProfileResponse.fromJson(json.decode(str));

String publicProfileResponseToJson(PublicProfileResponse data) => json.encode(data.toJson());
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    intoduction: json["intoduction"] !=null?Intoduction.fromJson(json["intoduction"]): json["intoduction"],
    basicInfo:json["basic_info"]!=null? BasicInfo.fromJson(json["basic_info"]):json["basic_info"],
    presentAddress: json["present_address"]!=null? EntAddress.fromJson(json["present_address"])  : json["present_address"],
    contactDetails: json["contact_details"]!=null? ContactDetails.fromJson(json["contact_details"]):json["contact_details"],
    ...
    physicalAttributes: json["physical_attributes"]!=null? PhysicalAttributes.fromJson(json["physical_attributes"]):json["physical_attributes"],
    knownLanguages:  json["known_languages"]!=null?  List<MotherTongue>.from(json["known_languages"].map((x) => MotherTongue.fromJson(x))): json["known_languages"],
    motherTongue:json["mother_tongue"]!=null? MotherTongue.fromJson(json["mother_tongue"]):json["mother_tongue"],
    hobbiesInterest: json["hobbies_interest"]!=null ?HobbiesInterest.fromJson(json["hobbies_interest"]):json["hobbies_interest"],
    attitudeBehavior: json["attitude_behavior"]!=null? AttitudeBehavior.fromJson(json["attitude_behavior"]):json["attitude_behavior"],
    residenceInfo: json["residence_info"]!=null?ResidenceInfo.fromJson(json["residence_info"]) : json["residence_info"],
    spiritualBackgrounds: json["spiritual_backgrounds"]!=null? SpiritualBackgrounds.fromJson(json["spiritual_backgrounds"]):json["spiritual_backgrounds"],
    lifestyles: json["lifestyles"]!=null? Lifestyles.fromJson(json["lifestyles"]): json["lifestyles"],
    astrologies:json["astrologies"]!=null? Astrologies.fromJson(json["astrologies"]):json["astrologies"],
    permanentAddress:json["permanent_address"]!=null? EntAddress.fromJson(json["permanent_address"]) :json["permanent_address"],
    familiesInformation: json["families_information"]!=null? FamiliesInformation.fromJson(json["families_information"]): json["families_information"],
    partnerExpectation: json["partner_expectation"]!=null? PartnerExpectation.fromJson(json["partner_expectation"]): json["partner_expectation"],
    photoGallery: List<PhotoGallery>.from(json["photo_gallery"].map((x) => PhotoGallery.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "known_languages": List<dynamic>.from(knownLanguages.map((x) => x.toJson())),
    ...
    "photo_gallery": List<dynamic>.from(photoGallery.map((x) => x.toJson())),
...
class AttitudeBehavior {
  ...
  factory AttitudeBehavior.fromJson(Map<String, dynamic> json) => AttitudeBehavior(
...
class FamiliesInformation {
  ...
  factory FamiliesInformation.fromJson(Map<String, dynamic> json) => FamiliesInformation(
    father: json["father"],
    mother: json["mother"],
...
class HobbiesInterest {
  ...
  factory HobbiesInterest.fromJson(Map<String, dynamic> json) => HobbiesInterest(
