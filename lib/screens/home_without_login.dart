...
class _HomeWithoutLoginState extends State<HomeWithoutLogin> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: state.exploreState.exploreList?.premiumMembers !=
                                null &&
                            state.exploreState.exploreList?.premiumMembers
                                .isNotEmpty
                        ? PageView.builder(
                            controller: controller,
                            itemCount: state
                                .exploreState.exploreList.premiumMembers.length,
  ...
  Widget user_info_box_with(
      BuildContext context, List<Member> members, int index, AppState state) {
    return Positioned(
      bottom: 0,
      right: 0,
      left: 0,
  ...
  Widget btn_and_age_country_row(
      List<Member> members, int index, BuildContext context) {
    return Row(
  ...
  Widget member_id_row(BuildContext context, List<Member> members, int index) {
    return Row(
      children: [
        Text(
  ...
  Widget name_icon_row(List<Member> members, int index) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Row(
  ...
  Widget image_container(List<Member> members, int index) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            ...
            image: members[index].photo == null
                ...
                : NetworkImage(members[index].photo),
            fit: BoxFit.cover),
