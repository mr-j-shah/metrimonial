                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          /// this block of code work for back to login page from verify page
    ...
    return InkWell(
      onTap: () {
        ...
        if (_verifyController.text.isEmpty) {
          MyScaffoldMessenger().sf_messenger(text: 'Please enter code.');
        } else if (_verifyController.text.length < 4) {
          MyScaffoldMessenger()
              .sf_messenger(text: 'Must be 4 character.');
        } else {

          store.dispatch(
              verifyMiddleware(context, code: _verifyController.text, fromPage: "verify"));
          // }
