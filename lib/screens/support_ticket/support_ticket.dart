...
import 'package:active_matrimonial_flutter_app/redux/libs/support_ticket/support_categories.dart';
import 'package:active_matrimonial_flutter_app/redux/libs/support_ticket/support_ticket_create.dart';
import 'package:active_matrimonial_flutter_app/redux/libs/support_ticket/support_ticket_create_reducer.dart';
...
import '../../redux/libs/support_ticket/store_support_ticket_reply_middleware.dart';
...
class _SupportTicketState extends State<SupportTicket> {
  ...
  Future getImage() async {
    try {
      ...
      // print("temp img #########${imageTemporay}");

      store.dispatch(StoreImageAction(
          image: imageTemporay,
          image_name: imageTemporay.path.split('/').last));

      // print(" img #########${store.state.supportTicketCreateState.image}");
      // print(
      //     " img name#########${store.state.supportTicketCreateState.img_name}");
  ...
  Future getReplyImage() async {
    try {
      ...
      // print(" img #########${store.state.supportTicketReplyState.image}");
      // print(
      //     " img name#########${store.state.supportTicketReplyState.img_name}");
    } on PlatformException catch (e) {
      print("Failed to pick Image: $e");
    }
  }
    ...
    return Expanded(
      child: state.supportTicketState.myTickets.isEmpty
          ...
          : SizedBox(
              ...
              child: state.supportTicketState.myTickets.isNotEmpty
                  ? buildTicketListView(state)
                  : Center(
                      child: Text(AppLocalizations.of(context).common_no_data),
                    ),
            ),
  ...
  Widget buildTicketListView(AppState state) {
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Container(
          /// box decoration
          margin: EdgeInsets.symmetric(horizontal: Const.kPaddingHorizontal),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                        child: Text(
                      AppLocalizations.of(context).support_ticket_status,
                      style: Styles.regular_arsenic_12,
                    )),
                    Expanded(
                        child: Text(
                      state.supportTicketState.myTickets[index].status == 0
                          ? "Pending"
                          : "Approved",
                ...
                buildNameDateRow(
                    name: AppLocalizations.of(context).support_ticket_subject,
                    data: state.supportTicketState.myTickets[index].subject),
                const SizedBox(
                  height: 5,
                ),
                buildNameDateRow(
                    name: AppLocalizations.of(context).support_ticket_category,
                ...
                buildNameDateRow(
                    name: AppLocalizations.of(context).support_ticket_new_reply,
                    data: DateFormat('yyyy-MM-dd').format(
                        state.supportTicketState.myTickets[index].createdAt)),
                const SizedBox(
                  height: 20,
                ),
                Row(
                  ...
                  children: [
                    /// alert dialog box
                    /// it will apear when click view
                    buildViewOfTicket(
                        state.supportTicketState.myTickets[index], state),
                  ],
                ),
              ],
            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      final delta =
                                          _reply_controller.document.toDelta();
                                      final convertedValue =
                                          jsonEncode(delta.toJson());
                                      final markdown =
                                          deltaToMarkdown(convertedValue);
                                      final html =
                                          markd.markdownToHtml(markdown);
                                      store.dispatch(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          width: 100,
                          height: 100,
                          child: MyImages.normalImage(detail.attachments),
                        )
                      ],
                    )
                  ],
          ...
          content: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  controller:
                      store.state.supportTicketCreateState.subjectController,
                ...
                Container(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items: state
                        .supportTicketState.myTicketCategoriesResponse.data
                ...
                InkWell(
                  onTap: () {
                    ...
                    final html = markd.markdownToHtml(markdown);
                    store.dispatch(supportTicketCreateMiddleware(
                        subject: store.state.supportTicketCreateState
