                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              /// age from field
                              Expanded(
                                child: BasicFormWidget(text:  AppLocalizations.of(context).search_secreen_age_from, controller: _ageFromController, style: Styles.bold_app_accent_12,),
                              ),
                              const SizedBox(
                                width: 10,
                              ),
                              ...
                              /// age to field
                              Expanded(
                                child: BasicFormWidget(text: AppLocalizations.of(context)
                                    .search_screen_to, controller: _ageToController, style: Styles.bold_app_accent_12,),
                              ),
                            ],
                          ),
                          const SizedBox(
