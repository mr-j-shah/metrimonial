    ...
    return InkWell(
      onTap: () {
        ...
        if (!_formKey.currentState.validate()) {
          ...
          NavigatorPush.push( page: ShowBasicSearch());
        }
      },
      child: Container(
        height: 50,
              ...
              Container(
                ...
                child: CommonWidget().buildDropdownButtonFormField(
                  ...
                  (value) {
                    ...
                    if (state.basicSearchState.casteResponse.data.isNotEmpty) {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 50,
                child: CommonWidget().buildDropdownButtonFormField(
                  state.manageProfileCombineState.profiledropdownResponseData.data.countryList,
                  (value) {
                    // country_value = value.id;
                    store.dispatch(SearchCountryAddValueAction(value: value.id));

                    if (state.basicSearchState.stateResponse.data.isNotEmpty) {
                      store.dispatch(SearchEmptyState());
                    }
                    if (state.basicSearchState.cityResponse.data.isNotEmpty) {
                      store.dispatch(SearchEmptyCity());
                    }

                    store.dispatch(stateMiddleware(value.id,state: AppStates.advancedSearch));
                  },
                ),
              ),
            ],
              ...
              Container(
                ...
                child: DropdownButtonFormField<dynamic>(
                  ...
                  onChanged: (dynamic newValue) {
                    ...
                    store.dispatch(cityMiddleware(newValue,AppStates.advancedSearch));
                  },
                ),
              ),
            ],
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonFormField<dynamic>(
                  ...
                  value:
                  state.basicSearchState.city_value,
