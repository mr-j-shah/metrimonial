  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder: (_, state) => Scaffold(
        appBar: CommonAppBar(text:  AppLocalizations.of(context).referral_earning_screen).build(context),
        body: Column(
          children: [
        ...
        child: state.referralEarningState.referralEarningList.isNotEmpty
            ? ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  if (index == state.referralEarningState.referralEarningList.length) {
                    return Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            buildNameDateRow(
                                ...
                                data: state.referralEarningState.referralEarningList[index].name),
                            const SizedBox(
                              height: 5,
                            ),
                            buildNameDateRow(
                                ...
                                data: state.referralEarningState.referralEarningList[index].amount),
                            const SizedBox(
                              height: 5,
                            ),
                            buildNameDateRow(
                                ...
                                data: state.referralEarningState.referralEarningList[index].date),
                          ]),
                    ),
                  );
                },
