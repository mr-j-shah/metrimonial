  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      builder: (_, state) => Scaffold(
        appBar: CommonAppBar(text: AppLocalizations.of(context).package_details)
            .build(context),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      state.featureState.feature.profilePicturePrivacy ==
                              "only_me"
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                          ...
                          : Column(),
                      state.featureState.feature.galleryImagePrivacy ==
                              "only_me"
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                      ...
                      Text(
                        ...
                        style:
                            state.packageDetailsState.data.autoProfileMatch == 1
