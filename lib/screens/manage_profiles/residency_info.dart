...
import 'package:active_matrimonial_flutter_app/redux/libs/manage_profile/manage_profile_middleware/residency_update_middleware.dart';
...
//state
        ...
        Container(
            ...
            child:
              ...
              onChanged: (dynamic newValue) {
                country_id = store.state.manageProfileCombineState.profiledropdownResponseData.data.countryList
      ...
      children: [
        ...
        Container(
            ...
            child:
              ...
              onChanged: (dynamic newValue) {
                residency_country_id = store.state.manageProfileCombineState.profiledropdownResponseData.data.countryList
                    .where((item) => item.name.contains(newValue))
                    .first
                    .id;
              },
      ...
      children: [
        ...
        Container(
          ...
          DropdownButtonFormField<dynamic>(
            ...
            onChanged: (dynamic newValue) {
              grow_up_country_id = store.state.manageProfileCombineState.profiledropdownResponseData.data.countryList
                  .where((item) => item.name.contains(newValue))
                  .first
                  .id;
            },
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        AppLocalizations.of(context).public_profile_residency_info,
