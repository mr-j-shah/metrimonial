...
import 'package:active_matrimonial_flutter_app/redux/libs/manage_profile/manage_profile_middleware/spiritual_update_middleware.dart';
...
class _SpiritualSocialState extends State<SpiritualSocial> {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, AppState>(
      ...
      onInit: (store) {
        print(store.state.manageProfileCombineState.spiritualSocialState
            .spiritualSocialGetResponse.toJson());

        if (store.state.manageProfileCombineState.spiritualSocialState
            .spiritualSocialGetResponse.result) {

          store.state.manageProfileCombineState.spiritualSocialState.ethnicityController.text =store.state.manageProfileCombineState.spiritualSocialState
              .spiritualSocialGetResponse.data.ethnicity;
          store.state.manageProfileCombineState.spiritualSocialState.personalController.text =store.state.manageProfileCombineState.spiritualSocialState
              .spiritualSocialGetResponse.data.personalValue;
          store.state.manageProfileCombineState.spiritualSocialState.communityController.text =store.state.manageProfileCombineState.spiritualSocialState
              .spiritualSocialGetResponse.data.communityValue;

          store.state.manageProfileCombineState.profiledropdownResponseData.data.religionList
              .forEach((element) {
          ...
          store.dispatch(casteMiddleware(store.state.manageProfileCombineState.spiritualSocialState
              .religion_val.id));
          store.state.manageProfileCombineState.profiledropdownResponseData.data.familyValueList.forEach((element) {
              if(element.name == store.state.manageProfileCombineState.spiritualSocialState
                  .spiritualSocialGetResponse.data.familyValueId)  {
                store.state.manageProfileCombineState.spiritualSocialState.family_val=element;
              }
          });
        }
              ...
              if (!_formKey.currentState.validate()) {
                ...
                store.dispatch(spiritualSocialUpdateMiddleware(
                    ...
                    religion: state.manageProfileCombineState
                        .spiritualSocialState.religion_val?.id??0,
                    caste: state.manageProfileCombineState.spiritualSocialState
                        .caste_val?.id??0,
                    sub_caste: state.manageProfileCombineState
                        .spiritualSocialState.sub_caste_val?.id??0,
                    ethnicity: state.manageProfileCombineState.spiritualSocialState.ethnicityController.text,
                    personal_value: state.manageProfileCombineState.spiritualSocialState.personalController.text,
                    family_value: state.manageProfileCombineState
                        .spiritualSocialState.family_val?.id,
                    community_value: state.manageProfileCombineState.spiritualSocialState.communityController.text));
              }
            },
            child: Container(
              height: 45,
      ...
      children: [
        ...
        Container(
          ...
          child: CommonWidget().buildCommonDropDown(
            state.manageProfileCombineState.profiledropdownResponseData.data.religionList,
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<DDown>(
            ...
            iconSize: 0.0,
            value:
                state.manageProfileCombineState.spiritualSocialState.caste_val,
  ...
  build_ethnicity(BuildContext context, AppState state) {
    return Column(
      ...
      children: [
        ...
        TextFormField(
          controller: state.manageProfileCombineState.spiritualSocialState.ethnicityController,
  ...
  build_personal_value(BuildContext context, AppState state) {
    return Column(
      ...
      children: [
        ...
        TextFormField(
          controller: state.manageProfileCombineState.spiritualSocialState.personalController,
          decoration:
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownButtonFormField<DDown>(
            ...
            iconSize: 0.0,
            value:
                state.manageProfileCombineState.spiritualSocialState.family_val,
            decoration: InputDecoration(
              hintText: "Select One",
              isDense: true,
              hintStyle: Styles.regular_gull_grey_12,
            ...
            items: state.manageProfileCombineState.profiledropdownResponseData.data.familyValueList
                .map<DropdownMenuItem<DDown>>((e) {
              return DropdownMenuItem<DDown>(
                value: e,
                child: Text(
  ...
  build_community_value(BuildContext context, AppState state) {
    return Column(
      ...
      children: [
        ...
        TextFormField(
          controller: state.manageProfileCombineState.spiritualSocialState.communityController,
          decoration:
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        AppLocalizations.of(context).public_profile_spiritual_n_social,
