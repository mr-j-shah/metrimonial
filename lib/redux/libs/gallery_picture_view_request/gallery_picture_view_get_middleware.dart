...
ThunkAction<AppState> getGalleryPictureViewRequestMiddleware({page =1}) {
  return (Store<AppState> store) async {
    ...
    try {
      var data = await GalleryPictureViewRepository().getGalleryPictureViewRequestList(page: page);
      store.dispatch(
...
class GalleryPictureViewRepository {
  Future<GalleryPictureViewRequestGetResponse>
    ...
    var baseUrl = "${AppConfig.BASE_URL}/member/gallery-image-view-request?page=$page";
