...
class SpiritualSocialState {
  final SpiritualBackgroundUpdateResponse spiritualBackgroundUpdateResponse;
  bool isloading;
  bool spSaveChanges;
  ...
  TextEditingController personalController =
  ...
  SpiritualSocialState(
      {this.spiritualBackgroundUpdateResponse,
