...
import 'package:active_matrimonial_flutter_app/redux/libs/manage_profile/manage_profile_reducer/profile_dropdown_reducer.dart';
...
ManageProfileCombineState manage_profile_combine_reducer(
  ...
  if(action is ManageProfileCommonDropdownValuesSetAction){
   ...
   // if(state.profiledropdownResponseData == null) {
      return  state.update(profiledropdownResponseData: action.data,);
    //}
    //return state;
  }
  ...
  return ManageProfileCombineState(
      ...
      partnerExpectationState: partner_expectation_reducer(state.partnerExpectationState, action),
