...
class InterestRequestLoadAction {}

class InterestRequestPaginator {
  var data;

  InterestRequestPaginator({this.data});
}

class InterestRequestReset {}

class InterestRequestHasMoreToggler {}
